...
//  ชื่อนักศึกษา : ศรณรงค์ เอี่ยมยัง
//  รหัสนักศึกษา : 663380512-6
// ╚══════════════════════════════════════════════════════════╝
//
//  โจทย์:
...
class Shipment {
    ...
    public String toString() {
        return String.format("[%s]  %.2f kg. | %s |    %.2f Baht", trackingNumber, weightKg, type, calculateCost());
    }
}
...
class ShippingCompany {
    ...
    public void printSummary() {
        System.out.println("========================================");
        System.out.printf ("  Company        : %s%n",   name);
        System.out.printf ("  Shipment Quantity : %d Items%n", shipments.size());
        System.out.println("========================================");
        ...
        System.out.println("----------------------------------------");
            // 2) แสดงยอดรวมตรงนี้
            System.out.printf ("  Total shipment cost : %.2f Baht%n", getTotalCost());
    }
}
